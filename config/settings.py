...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-1uo$zfoc6mce#s*$b_z-z#2d17b#7d#50cdel6dun&$fa@!!xg')
...
# Use PostgreSQL in production (Railway provides DATABASE_URL), SQLite in development
...
if not DEBUG:
    # Railway handles SSL/HTTPS at the load balancer, so we need to trust proxy headers
